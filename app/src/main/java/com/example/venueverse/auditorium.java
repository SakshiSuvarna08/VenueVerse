...
public class auditorium extends AppCompatActivity {
    ...
    private void fetchPlaceNamesAndPrices() {
        ...
        DatabaseReference placesRef = database.getReference("venue3/auditoriums");
        ...
        placesRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    Log.d("MainActivity", "No data found in venue1/auditoriums");
                }
            }
    ...
    private void openDetailsPage(String placeKey) {
        ...
        Intent intent = new Intent(this, audi_details.class);
